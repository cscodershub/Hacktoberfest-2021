define("layouts/consumer-premium", ["require", "exports", "module", "lib/lingua", "lib/layouts/page", "lib/futures"], function(e, t, n) {
        var r = e("lib/lingua"),
            ...
            o = n.exports = i.extend({
                ...
                getUpsellText: function() {
                    return r.t("Enjoy the free SoundCloud experience with our app.")
                }
            })
    }),
